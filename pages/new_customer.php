     ...
     <div class="row">
       ...
       <div class="col-sm-12 col-md-8">
         <div class="card create-card">
          <div class="card-body create-card-customer">
              <a href="../php/logout.php"><button id="customers"type="button"  class="btn btn-outline-primary">Logout</button></a>
              <form class="create-form" action="" method="post" id="create-customer">
             ...
             <div class="form-group">
              ...
              <button type="submit" name="submit" class="btn create-btn btn-lg">Create</button>
              <div id="result"></div>
            </form>
         </div>
        </div>
